<template>
  <div class="wrapper d-flex align-center">
      <p v-html="content"></p>
      <img width="300" src="https://demo-api.vsdev.space/storage/farm/home_page_img.jpg" alt="">
  </div>
</template>
